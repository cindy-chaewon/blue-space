...
function RightNav() {
    ...
    useEffect(() => {
        ...
        .then((response) => {   
            ...
            console.log('useEffect000', response)
            
            sessionStorage.setItem('teamId', teamListData[teamListData.length-1].teamId);
            console.log('useEffect111', teamListData[teamListData.length-1].teamId)
    ...
    const onSubmitHandler =  (event) => {
        ...
        .then(response =>{
            ...
            sessionStorage.setItem('teamName', response.payload.data.reault.teamName);
